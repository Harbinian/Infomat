...
| 文件 | 作用 | 口径 |
|---|---|---|
| `2026-09-09-mdm-3000-launch/` | 3000分阶段上线的执行基线、需求、整改证据及发布交接 | 第02阶段MySQL运行边界整改及隔离验证完成后停止；未进入03，首发范围仍待确认；沿用9月7日线下演练要求 |
...
| `2026-08-26-3001-pending-edit-safety-remediation/` | 3001未应用修改与误导性交互整改包 | 状态定义、统一三项保护、字段补丁、生命周期纯读取、删除安全和待执行验证记录；实施中 |
