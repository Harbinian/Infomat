...
└── data/
    └── platform.db          # SQLite 数据文件（gitignore）
```
...
**Files:**
- Create: `mdm-platform/server/index.js`
- Create: `mdm-platform/server/db.js`
- Create: `mdm-platform/package.json`
- Create: `mdm-platform/.gitignore`
...
```bash
mkdir -p mdm-platform/server/routes mdm-platform/public mdm-platform/data mdm-platform/scripts
cd mdm-platform && npm install
```

- [ ] **Step 6: Commit（在主仓库）**

```bash
git add mdm-platform/package.json mdm-platform/server/index.js mdm-platform/server/db.js mdm-platform/.gitignore
git commit -m "feat: scaffold MDM platform project with Express + SQLite"
```
...
**Files:**
- Create: `mdm-platform/server/auth.js`

- [ ] **Step 1: 创建 auth.js（同步版本，无 async）**

```javascript
// mdm-platform/server/auth.js
...
**Files:**
- Create: `mdm-platform/server/routes/org.js`

- [ ] **Step 1: 创建 org.js 路由**

```javascript
// mdm-platform/server/routes/org.js
const express = require('express');
...
**Files:**
- Create: `mdm-platform/server/routes/systems.js`
- Create: `mdm-platform/server/routes/capabilities.js`
- Create: `mdm-platform/server/routes/processes.js`

- [x] **Step 1: 创建 systems.js**

```javascript
// mdm-platform/server/routes/systems.js
const express = require('express');
const router = express.Router();
const db = require('../db');
...
```javascript
// mdm-platform/server/routes/capabilities.js
const express = require('express');
const router = express.Router();
const db = require('../db');
const { requireAuth } = require('../auth');
...
```javascript
// mdm-platform/server/routes/processes.js
const express = require('express');
const router = express.Router();
const db = require('../db');
const { requireAuth } = require('../auth');
...
```bash
git add mdm-platform/server/routes/systems.js mdm-platform/server/routes/capabilities.js mdm-platform/server/routes/processes.js
...
**Files:**
- Create: `mdm-platform/server/routes/mappings.js`
- Create: `mdm-platform/server/routes/fieldEntries.js`
- Create: `mdm-platform/server/routes/fieldIdentities.js`
...
```javascript
// mdm-platform/server/routes/mappings.js
const express = require('express');
const router = express.Router();
const db = require('../db');
const { requireAuth } = require('../auth');
...
```javascript
// mdm-platform/server/routes/fieldEntries.js
const express = require('express');
const router = express.Router();
const db = require('../db');
...
```javascript
// mdm-platform/server/routes/fieldIdentities.js
const express = require('express');
const router = express.Router();
const db = require('../db');
const { requireAuth } = require('../auth');
...
```bash
git add mdm-platform/server/routes/mappings.js mdm-platform/server/routes/fieldEntries.js mdm-platform/server/routes/fieldIdentities.js
...
**Files:**
- Create: `mdm-platform/server/routes/todos.js`
- Create: `mdm-platform/server/routes/conflicts.js`

- [x] **Step 1: 创建 todos.js**

```javascript
// mdm-platform/server/routes/todos.js
const express = require('express');
const router = express.Router();
const db = require('../db');
const { requireAuth } = require('../auth');
...
```javascript
// mdm-platform/server/routes/conflicts.js
const express = require('express');
const router = express.Router();
const db = require('../db');
const { requireAuth } = require('../auth');
...
```bash
git add mdm-platform/server/routes/todos.js mdm-platform/server/routes/conflicts.js
...
**Files:**
- Create: `mdm-platform/server/routes/terminology.js`
- Create: `mdm-platform/server/routes/versions.js`

- [x] **Step 1: 创建 terminology.js**

```javascript
// mdm-platform/server/routes/terminology.js
const express = require('express');
const router = express.Router();
const db = require('../db');
const { requireAuth, requireRole } = require('../auth');
...
```javascript
// mdm-platform/server/routes/versions.js
const express = require('express');
const router = express.Router();
const db = require('../db');
const { requireAuth } = require('../auth');
...
```bash
git add mdm-platform/server/routes/terminology.js mdm-platform/server/routes/versions.js
...
**Files:**
- Create: `mdm-platform/server/routes/export.js`

- [x] **Step 1: 创建 export.js**

```javascript
// mdm-platform/server/routes/export.js
const express = require('express');
const router = express.Router();
...
```bash
git add mdm-platform/server/routes/export.js
...
**Files:**
- Create: `mdm-platform/server/routes/import.js`
...
```javascript
// mdm-platform/server/routes/import.js
const express = require('express');
...
```bash
git add mdm-platform/package.json mdm-platform/server/index.js mdm-platform/server/routes/import.js
...
**Files:**
- Create: `mdm-platform/public/index.html`
- Create: `mdm-platform/public/template.xlsx`
...
```bash
git add mdm-platform/public/index.html mdm-platform/public/template.xlsx
...
**Files:**
- Create: `mdm-platform/scripts/init-db.js`
- Create: `mdm-platform/scripts/smoke-test.js`
- Create: `mdm-platform/README.md`

- [x] **Step 1: 创建 init-db.js**

```javascript
// mdm-platform/scripts/init-db.js
...
```javascript
// mdm-platform/scripts/smoke-test.js
const db = require('../server/db');
...
```bash
git add mdm-platform/scripts/init-db.js mdm-platform/scripts/smoke-test.js mdm-platform/README.md mdm-platform/package.json
...
**Plan complete and saved to `docs/superpowers/plans/2026-05-11-mdm-platform-implementation.md`. Two execution options:**
