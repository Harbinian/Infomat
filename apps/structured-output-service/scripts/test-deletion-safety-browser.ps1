...
$scenarioPath = Join-Path $PSScriptRoot 'deletion-safety-browser-scenario.js'
$artifactRoot = Join-Path $appRoot 'output/playwright'
$sessionName = "infomat-deletion-safety-$PID"
$npx = Get-Command npx.cmd -ErrorAction SilentlyContinue
if (-not $npx) { throw 'npx.cmd was not found. Install Node.js/npm before running this script.' }
...
Write-Host '3001 deletion-safety browser regression passed.'
