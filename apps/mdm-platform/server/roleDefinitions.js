...
const ROLE_GUIDES = [
  ...
  },
  {
    ...
    firstEntry: { label: 'V7流程核对', target: '#/processGovernance?workspace=v7Preview' },
  ...
  },
  {
    ...
    firstEntry: { label: '上传与核对V7', target: '#/processGovernance?workspace=v7Preview' },
    workflow: ['上传3001下载的未审核V7', '补充本部门流程事实', '答复定向业务事实问题', '提交部门审核'],
  ...
  },
  {
    ...
    firstEntry: { label: '跨部门承接待办', target: '#/processGovernance?workspace=v7Preview' },
