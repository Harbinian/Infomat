...
CREATE TABLE IF NOT EXISTS process_design_drafts (
  ...
  proxy_reason TEXT,
  l1_name TEXT,
  l1_status TEXT NOT NULL DEFAULT 'unclassified' CHECK(l1_status IN ('unclassified','needs_review','confirmed')),
  l2_name TEXT,
  l2_status TEXT NOT NULL DEFAULT 'unclassified' CHECK(l2_status IN ('unclassified','needs_review','confirmed')),
  l3_name TEXT,
