...
async function main() {
  ...
  [
    ...
    'id="pgHandoffQueueSection"',
    'id="pgHandoffConflictSection"',
    'id="pgHandoffStoryPanel"',
    'function loadCanonicalJsonForDraft',
    'function saveCanonicalJsonDraft',
    'function exportCanonicalJsonDraft',
    'function loadHandoffQueueView',
    'function showHandoffStory',
    'function loadHandoffConflictQueueView',
