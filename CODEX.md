...
3001当前导出`process-governance-v6`，兼容导入v1至v5、v6和历史多候选结构化JSON。流程图、数据关系图、文字编制和属性面板共同读写一份页面内存草稿；旧交接、工作角色、参考材料和内部流程调用只读归档。3000未增加v6兼容，v6文件不得描述为可直接导入3000；MDM-AI助手仍固定使用v5。
