...
根目录不应继续新增临时 YAML、截图、压缩包、解包目录或一次性调查文本。历史散放的根目录 PMO YAML 已归档到 `pmo/archive/page-snapshots/2026-06-05-playwright-yaml/`。当前仍散放的 `temp_survey.txt` 属于待归类资产，先登记后迁移。
