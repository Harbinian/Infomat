...
- As of 2026-07-28, 3001 provides a stateless read-only process-diagram tab generated from the current single-process form. New blank processes open in text editing, while imports with named behaviors open in diagram preview. The diagram draws only explicit valid relations, shows cross-department handoffs and internal calls as external placeholders, never persists coordinates or infers arrows, and never offers direct graphical editing.
